...
import { User, Envelope, Lock, ArrowLeft, Brain, Trophy, Lightbulb, Code, MusicNote, Eye, EyeSlash } from 'phosphor-react-native';
import Text from '@/components/ui/Text';
import { useAuth } from '@/hooks/useAuth';
import { Theme } from '@/theme';

const FLOATING_ICONS = [
  { Icon: Brain,     top: '6%',  left: '8%',   size: 32, opacity: 0.10, rotate: '-15deg', speed: 2400 },
  { Icon: Trophy,    top: '4%',  right: '12%', size: 24, opacity: 0.08, rotate: '12deg',  speed: 3100 },
  { Icon: Lightbulb, top: '18%', left: '26%',  size: 18, opacity: 0.07, rotate: '0deg',   speed: 2700 },
  { Icon: Code,      top: '14%', right: '28%', size: 26, opacity: 0.09, rotate: '-8deg',  speed: 2200 },
  { Icon: MusicNote, top: '26%', left: '5%',   size: 20, opacity: 0.08, rotate: '18deg',  speed: 3400 },
];
